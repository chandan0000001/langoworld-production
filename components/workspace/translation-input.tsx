...
export function TranslationInput({ data }: { data: any }) {
    return (
        <div className="relative flex items-center justify-center">
            <Handle type="source" position={Position.Right} className="!bg-transparent !border-none" />
            <Handle type="source" position={Position.Bottom} id="translation-bottom" className="!bg-transparent !border-none" />
            ...
            <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="relative group w-16 h-16 rounded-full bg-blue-500 shadow-[0_8px_32px_rgba(59,130,246,0.3)] flex items-center justify-center border-4 border-white dark:border-zinc-800 z-20 outline-none"
            >
                <motion.div
