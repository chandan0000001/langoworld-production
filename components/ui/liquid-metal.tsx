        ...
        return (
            ...
            >
                <div className="relative rounded-full overflow-hidden shadow-[0_20px_50px_-12px_rgba(0,0,0,0.25)]" style={{ padding: borderWidth }}>
                    ...
                    />
                    <div className={cn(
                        "relative z-10 rounded-full flex items-center bg-white dark:bg-black transition-colors group-hover:bg-neutral-50 dark:group-hover:bg-neutral-900 justify-center",
                        sizeStyles[size]
                    )}>
                        {icon && (
